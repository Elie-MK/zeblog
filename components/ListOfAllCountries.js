...
const ListOfAllCountries = ({flag, code, name, touch, setTouch}) => {
  return (
    <TouchableOpacity onPress={()=>setTouch(name)}  style={{flexDirection:"row",  marginTop:15, alignItems:"center", gap:20, borderWidth:`${touch === name?3 : 1}`, borderColor:`${touch === name?colors.main : colors.gray}`, borderRadius:7, padding:10}}>
